...
class _AiAssistantScreenState extends State<AiAssistantScreen> {
  ...
  void _sendMessage() {
    ...
    setState(() {
      _messages.add(_Message(text: text, isUser: true)); // adicionar a mensagem do usuário
      ...
      _messages.add(_Message(text: "Placeholder da mensagem de resposta do agente", isUser: false));
    });
    _controller.clear();
  }
